; ModuleID = '/home/user-admin/Desktop/2.0/Troodon/Training_Programs/matrixadd_kernel.cl'
source_filename = "/home/user-admin/Desktop/2.0/Troodon/Training_Programs/matrixadd_kernel.cl"
...
define spir_kernel void @matrixMul(float* nocapture, float* nocapture readonly, float* nocapture readonly, i32, i32) local_unnamed_addr #0 !kernel_arg_addr_space !3 !kernel_arg_access_qual !4 !kernel_arg_type !5 !kernel_arg_base_type !5 !kernel_arg_type_qual !6 {
  ...
  %15 = fadd float %12, %14
  %16 = getelementptr inbounds float, float* %0, i64 %10
  store float %15, float* %16, align 4, !tbaa !7
  ret void
}
